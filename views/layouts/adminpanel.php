        ...
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <nav class="classy-navbar" id="essenceNav">
                ...
                <div class="classy-menu">
                    ...
                    <div class="classynav">
                        <ul>
                            <li><a href="/adminpanel">Admin Index</a> </li>
                            <?php  if(!Yii::$app->user->isGuest)
                            echo  '<li><a href="#">Types</a>
                                <ul class="dropdown">
                                    <li><a href="/adminpanel">Admin Index</a></li>
                                    <li><a href="/adminpanelcategory">Categories</a></li>
                                    <li><a href="/adminpanelbook">Books</a></li>
                                </ul>
                            </li>';
                                else
                                    echo '<li><a href="#">Types</a>';?>
                ...
                <?php  if(!Yii::$app->user->isGuest)
                    {
                         echo '<div class="cart-area" >
                            <a href = "/adminpanel/logout" id = "essenceCartBtn" ><i class="fa fa-sign-out" style="font-size:25px; margin-top:30px;" aria-hidden="true"></i></a >
                        </div >';
                    }
                ?>
            </div>
